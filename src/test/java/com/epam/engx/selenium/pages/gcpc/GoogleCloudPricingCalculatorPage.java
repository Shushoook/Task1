...
public final class GoogleCloudPricingCalculatorPage extends Page implements com.epam.engx.selenium.pages.gcpc.Calculator {
    ...
    public Map<String, String> getParameters() {
        return new com.epam.engx.selenium.pages.gcpc.Parameters(driver).get();
    }
    ...
    public com.epam.engx.selenium.pages.gcpc.Estimate estimate() {
        click(addEstimateComputeEngineButton);
        return new com.epam.engx.selenium.pages.gcpc.Estimate(this);
    }
