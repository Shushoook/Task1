...
public final class Estimate extends PageFactory {
    ...
    private final com.epam.engx.selenium.pages.gcpc.GoogleCloudPricingCalculatorPage calculator;
    ...
    public Estimate(com.epam.engx.selenium.pages.gcpc.GoogleCloudPricingCalculatorPage calculator) {
